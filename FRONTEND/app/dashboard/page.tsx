...
export default function DashboardPage() {
  ...
  const dynamicHotelData = useMemo(() => {
    ...
    const occupancyRate = Math.round((occupiedRooms / totalRooms) * 100 * 10) / 10
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-blue-600">{dynamicHotelData.occupancyRate}%</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-blue-600">${dynamicHotelData.todayRevenue.toLocaleString()}</p>
                      <p className="text-xs text-green-600 flex items-center gap-1 mt-1">
                        <TrendingUp className="h-3 w-3" />
                        +12.5% from yesterday
                      </p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-blue-600">{dynamicHotelData.checkins}</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-blue-600">${dynamicHotelData.avgDailyRate}</p>
                      <p className="text-xs text-green-600 flex items-center gap-1 mt-1">
                        <TrendingUp className="h-3 w-3" />
                        +3.2% from last week
                      </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Scan booking QR code</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Add, edit & manage rooms</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Guest reviews & ratings</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Manage restaurant menu</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Configure AI assistants</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">View guest service requests</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="relative">
                  {roomsData.map(({ floor, rooms }, floorIndex) => (
                    <motion.div
                      ...
                      `}
                      style={{
                        height: `${Math.max(60, Math.min(100, 80 - (roomsData.length > 8 ? (roomsData.length - 8) * 5 : 0)))}px`,
                        ...
                        <div className="flex gap-1.5 flex-wrap justify-center max-w-full">
                          {rooms.map((room, roomIndex) => (
                            <motion.div
                              ...
                              className={`
                                relative ${rooms.length > 8 ? 'w-16 h-14' : rooms.length > 6 ? 'w-20 h-16' : 'w-24 h-18'} rounded-lg cursor-pointer shadow-lg border-2 border-white
                            ...
                            >
                              <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                                <span className={`${rooms.length > 8 ? 'text-[10px]' : 'text-xs'} font-bold ${room.status === 'available' || room.status === 'cleaning' ? 'text-slate-800' : 'text-white'} drop-shadow-lg`}>
                                  {room.number}
                                </span>
